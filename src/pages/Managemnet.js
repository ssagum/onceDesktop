...
const Management = () => {
  ...
  const [viewMode, setViewMode] = useState("staff"); // staff 또는 revenue
    ...
    <div className="flex flex-row w-full h-screen bg-onceBackground items-center">
      ...
      <MainZone className="w-full flex flex-col justify-evenly items-center bg-onceBackground p-[20px] h-screen">
        <div className="w-full h-full bg-white rounded-2xl p-4 flex flex-col">
          {/* 타이틀과 토글을 같은 행에 배치 */}
          <div className="flex flex-row items-center mb-6 px-5 mt-4">
            <span className="text-[34px] font-semibold">병원 관리</span>
